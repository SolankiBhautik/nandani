...
import { Check, Star, TrendingUp, Users, Award, ChevronRight, Link as IconLink } from "lucide-react"
      ...
      <main className="pt-32 pb-20">
        <div className="container mx-auto px-4">
          ...
          >
            <div className="flex flex-col md:flex-row items-start md:items-center gap-6 mb-8">
              <motion.div
                ...
                className="flex-shrink-0 w-20 h-20 md:w-24 md:h-24 rounded-3xl bg-gradient-to-br from-primary/10 to-accent/10 backdrop-blur-[2px] flex items-center justify-center text-primary border border-primary/20"
              >
              ...
              <div className="flex-1">
                ...
                <p className="text-lg md:text-xl text-muted-foreground">{service.description}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <motion.div
                ...
                whileHover={{ y: -4 }}
                className="bg-card/10 backdrop-blur-[2px] rounded-2xl p-4 border border-border/50 text-center"
              >
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: "-100px" }}
            transition={{ duration: 0.6, ease: [0.4, 0, 0.2, 1] }}
            className="bg-card/30 backdrop-blur-[2px]  rounded-3xl p-6 md:p-10 border border-border/50 shadow-lg mb-8 relative overflow-hidden"
          >
            {/* Decorative blurs */}
            ...
            <div className="relative mb-12">
              ...
              <p className="text-base md:text-lg text-muted-foreground leading-relaxed">{service.fullDescription}</p>
            </div>
            ...
            {/* Benefits */}
            <div className="relative mb-12">
              <h2 className="text-2xl md:text-3xl font-bold mb-6 flex items-center gap-3">What You Get</h2>
                  ...
                  >
                    <div className="relative">
                      <motion.div
                        ...
                        className="w-10 h-10 md:w-12 md:h-12 rounded-2xl bg-gradient-to-br from-primary to-accent text-white flex items-center justify-center font-bold text-lg flex-shrink-0 shadow-lg group-hover:shadow-xl transition-shadow"
                      >
                        {index + 1}
                      </motion.div>
          ...
          >
            <motion.div
              ...
              transition={{ type: "spring", stiffness: 300 }}
              className="bg-gradient-to-br from-primary/10 to-accent/10 backdrop-blur-[2px]  rounded-3xl p-6 md:p-10 border-2 border-primary/30 shadow-xl relative overflow-hidden"
            >
